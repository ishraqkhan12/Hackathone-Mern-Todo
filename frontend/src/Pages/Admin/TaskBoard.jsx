...
const TaskBoard = () => {
  ...
  return (
    <div className="w-full flex flex-col md:flex-row justify-between gap-4 px-4">
      {/* To Do Column */}
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="space-x-1">
                      <button className="bg-blue-500 text-white px-3 py-1 rounded-md text-sm hover:bg-blue-700 transition-colors">
                        <Link to={`/home/update/${task._id}`}>Edit</Link>
                      </button>
                      <button
                        onClick={() => handleDelete(task._id)}
                        className="bg-red-500 text-white px-3 py-1 rounded-md text-sm hover:bg-red-700 transition-colors"
                      >
                        Delete
                      </button>
                    </div>
